...
std::vector<Preset> getGlitchPresets()
{
    ...
    return {
        ...
        // --- Texture Scatter / Chaos ---
        makePreset("Scattered Signal", bank, {
            {"chainSlot0", 0.0f}
        }),
        makePreset("Texture Mayhem", bank, {
            {"chainSlot0", 0.0f}
        }),
        makePreset("Pixelated", bank, {
            {"chainSlot0", 0.0f}, {"chainSlot1", 1.0f}, {"destroyEnabled", 1.0f},
        ...
        makePreset("Static Burst", bank, {
            {"chainSlot0", 0.0f}, {"chainSlot1", 7.0f}, {"hazeEnabled", 1.0f},
        ...
        makePreset("Texture Stutter", bank, {
            {"chainSlot0", 0.0f}, {"chainSlot1", 10.0f}, {"stutterEnabled", 1.0f},
        ...
        makePreset("Digital Fracture", bank, {
            {"chainSlot0", 1.0f}, {"chainSlot1", 0.0f},
            {"destroyEnabled", 1.0f},
        ...
        makePreset("Codec Glitch", bank, {
            {"chainSlot0", 1.0f}, {"chainSlot1", 10.0f}, {"chainSlot2", 0.0f},
            {"destroyEnabled", 1.0f}, {"stutterEnabled", 1.0f},
        ...
        makePreset("Artifact Storm", bank, {
            {"chainSlot0", 1.0f}, {"chainSlot1", 0.0f}, {"chainSlot2", 7.0f},
        ...
        makePreset("Reverse Scatter", bank, {
            {"chainSlot0", 12.0f}, {"chainSlot1", 0.0f},
        ...
        makePreset("Data Moshing", bank, {
            {"chainSlot0", 0.0f}, {"chainSlot1", 10.0f}, {"chainSlot2", 1.0f}, {"stutterEnabled", 1.0f}, {"destroyEnabled", 1.0f},
        ...
        makePreset("System Error", bank, {
            {"chainSlot0", 1.0f}, {"chainSlot1", 10.0f}, {"chainSlot2", 11.0f}, {"chainSlot3", 0.0f},
            {"destroyEnabled", 1.0f}, {"stutterEnabled", 1.0f},
            {"shiftEnabled", 1.0f},
        ...
        makePreset("Texture Freeze", bank, {
            {"chainSlot0", 0.0f}
        }),
